...
//	kthread_runq->active_under_runq = &(kthread_runq->runqueues[2]);
//	kthread_runq->expires_under_runq = &(kthread_runq->runqueues[3]);
...
//	init_runqueue(kthread_runq->active_under_runq);
//	init_runqueue(kthread_runq->expires_under_runq);
