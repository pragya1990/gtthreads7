...
*/
	timeslice.it_interval.tv_sec = interval_sec;
	timeslice.it_interval.tv_usec = interval_usec;
	timeslice.it_value.tv_sec = value_sec;
	timeslice.it_value.tv_usec = value_usec;
